...
function Withdraw() {
    ...
    const handleSubmit = () => {
        ...
        axios.post("http://localhost:8080/account/withdraw", payload).then(resp =>
            alert("Rs." + resp.data.amount + " withdrawed")
        )
            .catch(error => {
        ...
        <div className="wrapper">
                ...
                <ul className="nav nav-pills flex-column mb-auto">
                    ...
                    <li>
                        <Link to="/customer/withdraw">
                            <p className="nav-link active">Withdraw</p>
                        </Link>
                    </li>
                    <li>
            ...
            <div className="container">
                ...
                <div className="container bg-light p-5">
                    ...
                    <button className="btn btn-dark btn-block" onClick={handleSubmit}>Withdraw</button>
                </div>
